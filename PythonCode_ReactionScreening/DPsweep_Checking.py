...
ParameterFile_Path = r'\\ad.monash.edu\home\User001\bzha0080\Desktop\Monash\02. ongoing project\09. ROP\Python CodeDPSweepExperimentParameter_Checking.xlsx'
...
FRInitiator = DesiredMonomerCon/(DesiredDP*StockConcentration[2])
